...
exports.playLezgiNumberTts = void 0;
const numToLezgi_1 = require("./numToLezgi");
...
function numberToSpokenLezgiAudioFiles(num, audioFilesPath) {
    const lezgiNumeralArray = (0, numToLezgi_1.numToLezgiArray)(num);
